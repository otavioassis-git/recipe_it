...
A beautiful and functional recipe mobile app built with Flutter. This project was developed as a portfolio piece to demonstrate mobile development skills.
...
- [Flutter](https://flutter.dev/) - The UI toolkit for building beautiful, natively compiled applications from a single codebase.
- [Dart](https://dart.dev/) - The programming language optimized for building fast apps on any platform.
...
```
git clone https://github.com/otavioassis-git/recipe_it.git
```
